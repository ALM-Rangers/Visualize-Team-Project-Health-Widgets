...
export class ReleaseStatus {
	public static getStatus(
		release: TFS_RM_Contracts.Release,
		showRejectedAsFailed: boolean): TFS_RM_Contracts.DeploymentStatus {

		let status: TFS_RM_Contracts.DeploymentStatus = TFS_RM_Contracts.DeploymentStatus.Succeeded;

		release.environments.forEach((environment) => {
			let stepStatus: TFS_RM_Contracts.DeploymentStatus = TFS_RM_Contracts.DeploymentStatus.Succeeded;
	...
	public static getStepStatus(
		deploymentAttempt: TFS_RM_Contracts.DeploymentAttempt,
		showRejectedAsFailed: boolean): TFS_RM_Contracts.DeploymentStatus {
